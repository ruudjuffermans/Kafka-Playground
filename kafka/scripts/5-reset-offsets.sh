...
kafka-consumer-groups.sh --command-config playground.config --bootstrap-server localhost:9092 --group my-first-application --reset-offsets --to-earliest --topic third_topic --execute

# describe the consumer group again
kafka-consumer-groups.sh --command-config playground.config --bootstrap-server localhost:9092 --describe --group my-first-application

# consume from where the offsets have been reset
kafka-console-consumer.sh --consumer.config playground.config --bootstrap-server localhost:9092 --topic third_topic --group my-first-application
